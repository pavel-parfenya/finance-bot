...
const FALLBACK_FAQS: CmsFaq[] = [
  ...
  },
  {
    ...
    answer:
      "Транзакции хранятся в нашей защищённой базе данных и доступны в любой момент через бот. Голосовые сообщения не сохраняются — используются только для распознавания.",
    sortOrder: 2,
  },
  {
    id: 4,
