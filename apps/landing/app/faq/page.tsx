...
const FALLBACK_FAQS: CmsFaq[] = [
  ...
  },
  {
    ...
    answer:
      "Free — текстовый ввод трат, базовая аналитика, Google Sheets. Pro добавляет голосовые сообщения, AI-распознавание, расширенную аналитику, прогнозы и совместный учёт.",
    sortOrder: 4,
  },
  {
    id: 6,
