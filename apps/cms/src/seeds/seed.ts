...
Стоимость подписки определяется актуальным тарифным планом, опубликованным на странице [/pricing](/pricing). Оплата производится в белорусских рублях (BYN) через платёжный шлюз bePaid.
...
По вопросам возврата: [[EMAIL]](/contacts)`,
  },
  {
    ...
    lastUpdated: null,
    content: `Подписка оформляется в боте. Оплата проходит через защищённый платёжный шлюз bePaid.
...
Оплата принимается в белорусских рублях (BYN). Все транзакции обрабатываются через сертифицированный платёжный шлюз bePaid. Данные карты не хранятся на наших серверах.
